...
public interface SysNoticeReadMapper
{
     ...
     * @return 未读数量
     */
    public int selectUnreadCount(@Param("userId") String userId);
     ...
     */
    public int selectIsRead(@Param("noticeId") String noticeId, @Param("userId") String userId);
     ...
     * @return 结果
     */
    public int insertNoticeReadBatch(@Param("userId") String userId, @Param("noticeIds") String[] noticeIds);
     ...
     */
    public List<SysNotice> selectNoticeListWithReadStatus(@Param("userId") String userId, @Param("limit") int limit);
