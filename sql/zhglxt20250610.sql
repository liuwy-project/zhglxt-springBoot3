...
) ENGINE = InnoDB AUTO_INCREMENT = 1062 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 1, '#', '', 'M', '0', '1', '', 'fa fa-gear', 'admin', '2025-06-09 19:10:05', '', NULL, '系统管理目录');
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 2, '#', '', 'M', '0', '1', '', 'fa fa-video-camera', 'admin', '2025-06-09 19:10:05', '', NULL, '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 3, '#', '', 'M', '0', '1', '', 'fa fa-bars', 'admin', '2025-06-09 19:10:05', '', NULL, '系统工具目录');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '100', 'system', '超级系统管理员', '00', 'xx@qq.com', '18888888888', '0', '', 'a430a9104181df477d077f1673208fb1', '111111', '0', '0', '127.0.0.1', '2025-06-10 20:53:21', '2025-06-10 17:43:21', 'system', '2025-06-09 19:10:05', 'system', '2025-06-10 20:53:20', '超级系统管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('e9540bfc-067b-4a5b-9cfd-432d8d3569bc', 'system', '集团', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', 'on_line', '2025-06-10 20:40:25', '2025-06-10 20:57:37', 14400000);
